					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
								...
								<?php if ($childs) { $no = 1; foreach ($childs as $child) { $age = new DateTime($child->child_dob); $today = new DateTime('today');?>
									<tr id="<?php echo $child->child_id; ?>">
										<td class="table-plus"><?php echo $no; ?></td>
										<td><?php echo $child->child_name; ?></td>
										<td>
											<span class="badge badge-<?php echo $genders[$child->user_gender]['label']; ?>"><?php echo $genders[$child->user_gender]['name']; ?></span>
                                        </td>
										<td><?php echo $today->diff($age)->y == 0 ? $today->diff($age)->m.' Bulan' : $today->diff($age)->y.' Tahun'; ?></td>
										<td><?php echo $child->parent_mother_name; ?></td>
										<td><?php echo $child->parent_phone; ?></td>
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<a href="javascript:;" class="dropdown-item btn-block btn-modal-view" data-id="<?php echo $child->child_id; ?>" data-paths="<?php echo $pagePaths; ?>"><i class="dw dw-eye"></i> Detail</a>
													<button type="button" class="dropdown-item" onclick="location.href='<?php echo base_url($pageCurrent.'/update/'.$child->child_id); ?>'"><i class="dw dw-edit2"></i> Edit</button>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" name="child_name"class="form-control" readonly>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="child_pob" class="form-control" readonly>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>Tanggal Lahir</label>
														<input type="date" name="child_dob" class="form-control" readonly>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="parent_father_name" class="form-control" readonly>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>Nama Ibu</label>
														<input type="text" name="parent_mother_name" class="form-control" readonly>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<label>Nomor Handphone</label>
														<input type="text" name="parent_phone" class="form-control" readonly>
													</div>
												</div>
											</div>
										</div>
