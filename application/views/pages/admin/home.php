					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Anak</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#00eccf"><i class="icon-copy fa fa-child"></i></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Terapis</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#ff5b5b"><span class="icon-copy fa fa-heartbeat"></span></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Video</div>
							</div>
							<div class="widget-icon">
								<div class="icon"><i class="icon-copy dw dw-video-player" aria-hidden="true"></i></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Materi</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06"><i class="icon-copy fa fa-file-pdf-o" aria-hidden="true"></i></div>
							</div>
						</div>
					</div>
				</div>
