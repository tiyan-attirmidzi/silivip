						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo form_error('user_fullname') ? "has-danger" : " "; ?>">
									...
									<input type="text" name="user_fullname" value="<?php echo set_value('user_fullname'); ?>" class="form-control <?php echo form_error('user_fullname') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Nama Lengkap">
							...
							<div class="col-md-12">
								<div class="form-group <?php echo form_error('therapist_phone') ? "has-danger" : " "; ?>">
									...
									<input type="text" name="therapist_phone" value="<?php echo set_value('therapist_phone'); ?>" class="form-control <?php echo form_error('therapist_phone') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Nomor Handphone">
