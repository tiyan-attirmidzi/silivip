						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group <?php echo form_error('user_name') ? "has-danger" : " "; ?>">
									...
									<input type="text" name="user_name" value="<?php echo set_value('user_name'); ?>" class="form-control <?php echo form_error('user_name') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Username">
							...
							<div class="col-md-6">
								<div class="form-group <?php echo form_error('user_email') ? "has-danger" : " "; ?>">
									...
									<input type="email" name="user_email" value="<?php echo set_value('user_email'); ?>" class="form-control <?php echo form_error('user_email') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Email">
							...
							<div class="col-md-6">
								<div class="form-group <?php echo form_error('user_password_confirm') ? "has-danger" : " "; ?>">
									<label>Ulangi Password</label><span class='text-danger'> *</span>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo form_error('child_name') ? "has-danger" : " "; ?>">
									...
									<input type="text" name="child_name" value="<?php echo set_value('child_name'); ?>" class="form-control <?php echo form_error('child_name') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Nama Lengkap">
							...
							<div class="col-md-6">
								<div class="form-group <?php echo form_error('child_pob') ? "has-danger" : " "; ?>">
									...
									<input type="text" name="child_pob" value="<?php echo set_value('child_pob'); ?>" class="form-control <?php echo form_error('child_pob') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Tempat Lahir">
							...
							<div class="col-md-6">
								<div class="form-group <?php echo form_error('child_dob') ? "has-danger" : " "; ?>">
									...
									<input type="date" name="child_dob" value="<?php echo set_value('child_dob'); ?>" class="form-control <?php echo form_error('child_dob') ? "form-control-danger" : " "; ?>">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group <?php echo form_error('parent_father_name') ? "has-danger" : " "; ?>">
									...
									<input type="text" name="parent_father_name" value="<?php echo set_value('parent_father_name'); ?>" class="form-control <?php echo form_error('parent_father_name') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Nama Ayah">
							...
							<div class="col-md-6">
								<div class="form-group <?php echo form_error('parent_mother_name') ? "has-danger" : " "; ?>">
									...
									<input type="text" name="parent_mother_name" value="<?php echo set_value('parent_mother_name'); ?>" class="form-control <?php echo form_error('parent_mother_name') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Nama Ibu">
							...
							<div class="col-md-12">
								<div class="form-group <?php echo form_error('parent_phone') ? "has-danger" : " "; ?>">
									...
									<input type="text" name="parent_phone" value="<?php echo set_value('parent_phone'); ?>" class="form-control <?php echo form_error('parent_phone') ? "form-control-danger" : " "; ?>" placeholder="Masukkan Nomor Handphone">
